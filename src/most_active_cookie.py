    ...
    def find_most_active_cookies(self, target_date: str) -> list[str]:
        ...
        try:
            with open(self.log_file, encoding="utf-8") as file:
                ...
                # the following block might need to change if we might expect
                # CSVs in different structures with similar content
                ...
                for line_num, line in enumerate(file, start=2):
                    ...
                    try:
                        ...
                        if log_date == target_date:
                            # found a cookie id on our desired day
                            ...
                            logger.debug(
                                f"Reached dates before target at line "
                                f"{line_num}, stopping"
                            )
                            break
